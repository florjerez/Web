...
(function(){
  const DICT = {
    en: {
      ...
      "contact.error.network": "Something went wrong. Please email jerezflorencia@gmail.com directly.",
    ...
    es: {
      ...
      "contact.error.network": "Algo falló. Escribí directo a jerezflorencia@gmail.com.",
